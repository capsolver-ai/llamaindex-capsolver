...
# llamaindex-capsolver

**Official CapSolver FunctionTools for LlamaIndex agents and agent workflows.**
...
~~~bash
pip install llamaindex-capsolver
...
~~~mermaid
flowchart LR
    A["LlamaIndex application"] -->|"verification detected"| B["llamaindex-capsolver"]
